...
const EnrolledCourses = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 
                ...
                font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5
                text-sm sm:text-base w-full sm:w-auto animate-pulse hover:animate-none"
            >
      ...
      ============================================ */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 sm:p-5 mb-6 sm:mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">

          {/* Left: Live Course Info */}
          <div className="flex items-start sm:items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-600 text-xs sm:text-sm mt-0.5">
                Access your courses anytime, anywhere with lifetime access
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to="/student/live-sessions"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 sm:py-2 
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 sm:py-2 
                bg-white border border-blue-200 text-blue-700 rounded-lg 
                hover:bg-blue-50 transition-colors text-xs sm:text-sm font-medium"
            >
          ...
          >
            ...
            <div className="relative overflow-hidden">
              <img
                ...
                alt={course.title}
                className="h-36 sm:h-40 lg:h-44 w-full object-cover group-hover:scale-105 transition-transform duration-500"
                onError={(e) => {
            ...
            <div className="p-4 sm:p-5 flex-1 flex flex-col">
              ...
              {/* Title */}
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-violet-600 transition-colors">
                {course.title}
              </h3>
              ...
              <div className="space-y-2 mb-4">
                ...
                {course.difficulty_level && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium border ${getDifficultyBadge(course.difficulty_level)}`}>
                      {course.difficulty_level}
                    </span>
                  </div>
                )}
                ...
                {course.enrolled_at && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-800">
                      {new Date(course.enrolled_at).toLocaleDateString('en-IN', {
                        day: 'numeric',
                        month: 'short',
                        year: 'numeric'
                      })}
              ...
              <div className="flex flex-col gap-2 mt-auto pt-4 border-t border-gray-100">
                ...
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 
                    bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-lg 
                    hover:from-red-600 hover:to-orange-600 transition-all duration-300 
                    font-medium text-sm"
                >
                ...
                <Link
                  to="/student/resources"
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 
                    border-2 border-violet-600 text-violet-600 rounded-lg 
                    hover:bg-violet-50 transition-colors font-medium text-sm"
                >
      ...
      {/* ============================================
    LIVE SESSION ALERT & NOTIFICATION INFO
============================================ */}
      <div className="bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 border border-red-200 rounded-xl mt-12 p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 sm:gap-6">
          ...
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-red-800 text-base sm:text-lg flex items-center gap-2 flex-wrap">
                🔴 Live Sessions Available
                <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-red-100 text-red-600 rounded-full text-xs font-medium animate-pulse">
                  LIVE
                </span>
              </h3>
          ...
          <Link
            to="/student/live-sessions"
            className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 
        bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-xl 
        hover:from-red-600 hover:to-orange-600 transition-all duration-300 
        font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5
        text-sm sm:text-base w-full lg:w-auto flex-shrink-0"
          >
        ...
        {/* How You'll Be Notified Section */}
        <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 sm:p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            ...
            <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                <p className="font-medium text-green-800 text-sm">Executive Call</p>
                <p className="text-green-600 text-xs mt-0.5">
                  Our executive will call you before each live session
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                <p className="font-medium text-blue-800 text-sm">Email Alert</p>
                <p className="text-blue-600 text-xs mt-0.5">
                  You'll receive email notifications with session details
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div>
                <p className="font-medium text-purple-800 text-sm">Push Notification</p>
                <p className="text-purple-600 text-xs mt-0.5">
                  Check your notification bell for updates
                </p>
              </div>
            </div>
          </div>

          {/* Check Notifications Link */}
          ...
          bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg 
      ...
      <div className="mt-8 sm:mt-10 bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl p-6 sm:p-8 text-white">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-violet-100 text-sm sm:text-base">
              Our support team is here to help you succeed. Reach out for any questions about your enrolled courses, live sessions, technical issues, or learning resources.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 
                bg-white text-violet-600 rounded-xl hover:bg-violet-50 
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 
                bg-violet-500 text-white rounded-xl hover:bg-violet-400 
                transition-colors font-semibold text-sm sm:text-base border border-violet-400"
            >
        ...
        {/* Quick Info */}
        <div className="mt-6 pt-6 border-t border-violet-400/30 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-violet-200 text-xs">Mon-Sat, 9AM - 6PM IST</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-violet-200 text-xs">Interactive classes daily</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-violet-200 text-xs">All courses & updates</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-violet-200 text-xs">PDFs, code & more</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Bottom padding for floating buttons on mobile */}
